...
plasma::plasma(const Vector2f& position, Vector2f direction, float angle) : aoe_projectile(position, 4, direction, angle)
{
	emp = true;
	projectile_damage_ = 50;
	max_force_ = 1000;
...
void plasma::update(float delta_t)
{
...
void plasma::explode(Vector2f explosion_area)
{
	hasExploded = true;
